...
export default {
  ...
  computed: {
    filteredItems() {
      ...
      return this.getTagsLabels(this.blogTags).filter(tag => {
      ...
      beforeAddTag(obj){
        ...
        if (!existingTag) {
          ...
          .then(async result => {
              ...
              vuexFormSetValue(this.FORM_ID, "tags", [...vuexFormGetValue(this.FORM_ID, 'tags'), tag]);
              obj.addTag();
          })
          .catch(error => {
          ...
          vuexFormSetValue(this.FORM_ID, "tags", [...vuexFormGetValue(this.FORM_ID, 'tags'), existingTag]);
          obj.addTag();
        }
      },
      beforeDeleteTag(obj) {
        // console.log('remove tag', obj);
        vuexFormSetValue(this.FORM_ID, "tags", vuexFormGetValue(this.FORM_ID, 'tags').filter(t => t .name !== obj.tag.text));
        obj.deleteTag()
      }
  }
};
