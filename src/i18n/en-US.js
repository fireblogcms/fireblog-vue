...
export default {
  ...
  "views.blogSettings.deployWebhookForm.fields.webhooks.help": "Those webhooks will be triggered on content changes. You can specify multiple valid URLs by comma-separating them.",
  "views.blogSettings.deployWebhookForm.notifications.saved": "Technical settings saved.",
  "views.blogSettings.deployWebhookForm.saveButton": "Save",
  "views.blogSettings.deployWebhookForm.title": "Technical settings",
