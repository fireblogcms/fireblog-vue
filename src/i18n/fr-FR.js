...
export default {
  ...
  "components.slugField.help": "Le slug est utilisé pour créer une URL SEO-friendly pour votre article. Seuls les minuscules et le caractère '-' sont autorisés.<br />Example d'utilisation du slug : {exampleUrl}<br />",
  ...
  "components.slugField.unlockConfirmModal.content": "Attention ! modifier l'URL peut casser les liens existants vers votre site et causer des erreurs 404 de page non trouvée. Ne modifiez ce champ que si vous savez ce que vous faites!",
  ...
  "views.blogCreate.createButton": "Créer un blog",
  "views.blogCreate.fields.ambiance.label": "Ambiance",
  ...
  "views.blogCreate.fields.description.label": "De quoi parleront les articles de ce blog ?",
  ...
  "views.blogList.createNewBlogButton": "AJouter un blog",
  ...
  "views.blogSettings.generalSettingsForm.fields.image.label": "Une image d'illustration pour ce blog",
  ...
  "views.blogSettings.tagsSettingsForm.title": "Catégories",
  "views.blogSettings.tagsSettingsForm.help": "Vous pouvez utilisez les catégories pour regrouper vos articles en différentes thématiques (par exemple: \"musique\")",
  "views.blogSettings.tagsSettingsForm.saveButton" : "Modifier ou créer des catégories",
  ...
  "views.postForm.sectionTags.title": "Catégorie(s)",
  ...
  "views.postList.deleteModal.title": "Supprimer cet article",
  "views.postList.deleteModal.confirmButton": "Supprimer",
  "views.postList.deleteModal.content": "Attention ! Cette action est irréversible. <strong>{postTitle}</strong> sera effacé définitivement.",
  ...
  "views.tagForm.backToBlogLink": "Catégories",
  "views.tagForm.fieldDescription": "Description courte",
  ...
  "views.tagList.deleteModal.title": "Supprimer une catégorie",
  "views.tagList.deleteModal.content": "Attention! <strong>\"{tagName}\"</strong> sera supprimée définitivement.",
};
