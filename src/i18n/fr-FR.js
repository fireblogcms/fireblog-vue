...
export default {
  ...
  "components.slugField.help": "Utilisé pour construire une url SEO-friendly pour votre post.<br /> Par exemple : {exampleUrl}<br /> Seuls les minuscules et le caractère '-' sont autorisés",
  "components.slugField.label": "Slug",
  "components.slugField.lock": "Verrouiller",
  "components.slugField.unlock": "Déverouiller",
  "global.close": "Fermer",
